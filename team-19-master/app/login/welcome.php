 ...
 <style id="applicationStylesheet" type="text/css">
  ...
  header img{
	...
	letter-spacing: 1px;
 	...
 	#Matchmaking_or_creating_tourna {
 		position: absolute;
 		left: 133px;
 		top: 410px;
 		overflow: hidden;
 	...
 	#cartoon_sports_pictures_148963 {
 		position: absolute;
 		width: 752.5px;
 		height: 423px;
 		left: 960px;
     ...
     .button {
   background-color:  #99000093;
   border: 3px solid  #99000093;
   border-radius: 20px;
   color: white;
   padding: 0.5em 2.5em;
 ...
 */
 ...
 <div id="">
        ...
        <section class="menu_section">
                 <div class=""></div>
                 <header>
					<img src="images/Inviter_logo.png" alt="Inviter Logo" style="width:300px;">  <!--Logo Part -->
                 </header>
        </section>

 	<div id="Welcome_to_Inviter_">
 		<h1>WELCOME to INVITER </h1>
 	</div>
 	<div id="Matchmaking_or_creating_tourna">
 		<span>Matchmaking or creating tournament never been easier then this...</span><br><span style="font-style:normal;font-weight:normal;font-size:20px;"><br/>Inviter is a website-base application where people can host or join sports match  in real-time. Inviter is click-right feature to accept a team to compete with and click-left feature to avoid to compete the team for chosen sports. Every user can register own account for an individual or the team. <br/><br/>After making an account, the user is available for choosing certain sports to start finding the sports matches around near location (e.g. Bloomington area). The user will be provided all notifications that collect the matches that other If the two teams have been matched as both clicking “Accept”, both teams will have a chance to set up a schedule for sports match.</span>
 	</div>
 	<div id="Want_to_join_our_community_">
 		<span>Want to join our community?</span>
 	</div>
 	<img id="cartoon_sports_pictures_148963" src="images/welcome.png" srcset="images/welcome.png 1x, images/welcome.png 2x">
